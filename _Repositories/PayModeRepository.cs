    ...
    internal class PayModeRepository : BaseRepository, IPayModeRepository
    {
        ...
        public void Add(PayModeModel payModeModel)
        {
            ...
            using (var command = new SqlCommand())
            {
                ...
                command.Parameters.Add("Cobservation", SqlDbType.NVarChar).Value = payModeModel.Observation;
        ...
        public void Delete(int id)
        {
            ...
            using (var command = new SqlCommand())
            {
                connection.Open);
                command.Connection = connection;
                command.CommandText = "DELETE FROM payMode = WHERE WHERE Pay_Mode_Id = @id";
        ...
        {
            var payModeList = new List<PayModeModel>();
            int payModeld = int.TryParse(value, out _) ? Convert.ToInt32(value) : 0;
            ...
            using (var command = new SqlCommand())
            {
                ...
                command.Parameters.Add("@id", SqlDbType.Int).Value = payModeld;
